...
const Layout = () => {
  ...
  return (
    <div className="App flex flex-col min-h-screen dark:bg-dark-background bg-white bg-big-screen bg-repeat-y font-body text-black dark:text-white text-dynamic-base leading-11 leading-dynamic-base readerMode:leading-loose readerMode:bg-[#faebd7]">
