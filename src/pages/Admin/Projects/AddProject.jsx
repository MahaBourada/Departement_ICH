  ...
  return (
    <main className="mx-14 my-20">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col m-5">
        ...
        <p className="font-medium font-main dyslexiaTheme:font-dyslexia my-4">Ajout des membres</p>

        {membres.map((membre, index) => (
          <div key={index}>
            <div className="flex items-center justify-between">
              <p className="font-medium font-main dyslexiaTheme:font-dyslexia">Membre {index + 1}</p>
