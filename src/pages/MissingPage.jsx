  ...
  return (
      <main className="flex-grow flex min-h-screen items-center justify-evenly max-lg:flex-col my-20 mx-auto text-black dark:bg-dark-background dark:text-dark-white">
        <div className="flex flex-col items-center w-[55%] max-lg:w-fit">
          ...
          <button
            onClick={() => navigate(-1)}
            className="bg-accent dark:bg-dark-accent dark:text-black hover:bg-dark-accent font-main font-medium text-2xl max-md:text-lg py-5 px-7 max-md:py-4 max-md:px-5 rounded-2xl max-md:rounded-xl cursor-pointer"
          >
            {t("404.button")}
          </button>
        </div>
